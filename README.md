...
その人にとって主観的に好きと思ったコンテンツを一つ選び、
シンポジウムの最後にビブリオバトルのように「推し語る」制度です。

この制度はエンタテインメントの「面白さ」を評価する観点を多角的に捉えるための実践として実施されています。
語り手自身の経験・価値観と結びつけることで「なぜ刺さったか」を分析する手掛かりになることを期待して、これらの語りが蓄積され続けています。

c.f. [エンタテインメントシンポジウム2025におけるRe:commend-demoトーク録](https://dl.mtstlab.org/papers/468)

## このツールの狙い

本リポジトリでは次の問いに取り組むことを目標に掲げています：
- LLMに論文を与え、Re:commend-demo の説明付きプロンプトで自由に「刺さり」を語らせたとき、
  人手の語りにどこまで迫れるか？人手の語りになかった部分はどこか？逆に、人手にしか担当できない側面はどこか。

近年の大規模言語モデルの発展をうけ、EC領域ではコンテンツの分析にどう利活用できるか、という議論が巻き起こっています。
例えば、コンテンツの仕様が載った論文をLLMに流せば、そのコンテンツで起こりうる体験を推定し、言語化できます。
一度言語化してしまえば、[EC分野の全研究を「面白さ」の種類に基づいて整理する](https://appbird.github.io/entertainment-design-catalog/)といったことも可能になりそうです。

Re:commend-demo の本質は「語り手の経験に基づく語り」にあるため、
LLM が語れるからといって、Re:commend-demoを直接自動化できるわけではありません。
しかし、これらがうまく利活用されれば、Re:commend-demoでの言語化支援ツールとしてLLMを活用したり、
語りで明瞭に言語化されなかったコンテンツの仕掛けと起こった「面白さ」との対応関係を調べたり、といった研究の発展もありえます。
従って、適切に運用されるべく、大規模言語モデルと人手の語りをどのように使い分けるべきかを切り分ける必要がありました。
